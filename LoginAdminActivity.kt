...
import com.example.libraryappcodex.databinding.ActivityLoginAdminBinding
        ...
        ref.child(firebaseUser.uid)
            .addListenerForSingleValueEvent(object : ValueEventListener {
                ...
                override fun onDataChange(snapshot: DataSnapshot) {
                    ...
                    if(userType=="admin"){
                        //its admin dashboard
                        startActivity(Intent(this@LoginAdminActivity, DashboardAdminActivity::class.java))
                    }
                }
